...
pairs = [
    [r'(.*)depress(.*)',
     ["Diverting your mind and working on something you love might help. A few examples are, listening to music and drawing something you like.",
      "Sometimes things look tough but as time passes it feels much better. So, for now, try doing things you enjoy. You can go for a brisk walk or enjoy a food you like."]],
      
    [r'negative (.*)',
     ["You seem to be dull, you want to tell me more about it?",
      "Is there something that's bothering you?",
      "Do you think you need to talk to a human to feel better?"]],

    [r'(.*)human(.*)',
     ["Please contact SAMHSA’s National Helpline number 800-662-4357 for professional support.",
      "Please call 988 for Suicide and Crisis Lifeline for professional help."]],
    ...
    [r'(.*) husband(.*)',
     ["Tell me more about your husband."
	  "What exact problems are you facing with your husband?",
	  "Do you think your husband is having any external affairs?",
	  "Did you try talking to your husband about this current scenario?",
      "Do you think your husband is hiding something from you? Are you certain? If yes, why do you feel so?"	  
	  ]],
